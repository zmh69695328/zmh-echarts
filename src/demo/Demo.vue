  ...
  series: [
    {
      name: "当日回收金额",
      data: [
        20000, 40000, 70000, 23000, 25600, 76700, 13560, 16220, 32600, 20000,
        140000, 30003, 20000, 40000, 70000, 23000, 25600, 76700, 13560, 16220,
        32600, 20000, 140000, 30003
      ]
    },
    {
      name: "目标达成率",
      data: [
        20, 22, 33, 45, 63, 102, 103, 23, 23, 160, 120, 62, 20, 22, 33, 45, 63,
        102, 103, 23, 23, 160
      ]
    }
  ]
...
<template>
  <main>
    ...
    <h1>
      <a href="https://github.com/ecomfe/vue-echarts">Pui-ECharts</a>
    </h1>
    <p class="desc">
    ...
    <top-twenty title="全组员工当日达标完成情况" :data="data"/>
    <bar-chart />
    <pie-chart />
    <polar-chart />
    <scatter-chart />
